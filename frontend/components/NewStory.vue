<template>
    <div class="nav-new-update menu-block">
        ...
        <div class="tab-content tab-content-new-update" id="myTabContent">
            <div
                    ...
                    <div class="item-list">
                        ...
                        <div class="post-info">
                            ...
                            <div class="entry-meta">
                                <span class="byline">
                                    <i class="fa fa-file-word-o"></i> 22 Chương
                                    -
                                    <i
                                        class="fa fa-clock-o"
                                    ></i>
                                    <time
                                        class="timeago"
                                        datetime="2019-06-21T16:09:03+07:00"
                                        title="21/06/2019"
                                    >21 ngày trước</time>
                                </span>
                            </div>
